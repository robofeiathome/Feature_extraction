...
class FeaturesRecognition:
    ...
    def funKeypoints(self,img):
        ...
        #result_keypoint = result.cpu.keypoints.xy.numpy()[0]
        ...
        '''        
        cv2.circle(img,(nareba,ombro),5,(255,0,0),10)
        cv2.circle(img,(nareba,quadril),5,(0,255,0),10)
        cv2.imwrite(PATH +'/data/keypoints.jpg',img)
        '''

        shirt = img[ombro:quadril-30,20:-20]
    ...
    def funColor(self,path):
        ...
        if R >= 100 and R <= 255 and G >= 0 and G <= 80 and B >= 0 and B <= 80:
            ...
            cor = 'Pink'
        elif R >= 0 and R <= 31 and G >= 0 and G <= 31 and B >= 0 and B <= 31:
            cor = 'Gray'
